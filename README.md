...
- Steps
    ...
    ## Running locally and pushing to GitHub

    1. Ensure Java 8+ and Maven are installed and on `PATH`.
    ...
    4. To push changes to GitHub (example remote):

    ```powershell
    git remote add origin https://github.com/Mission-Underwriters/MissionQaTest.git
    git add -A
    git commit -m "Implement POM and API/UI steps, align with QA guidelines"
    git push -u origin HEAD:main
    ```

    If your repository uses `master` instead of `main`, replace `main` above.
